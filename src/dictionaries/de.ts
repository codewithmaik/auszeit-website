...
export const dictionary = {
  ...
  wohnung: {
    ...
    heroTitle: "7 Wohnungen, ein Zuhause an der Mosel",
    heroText:
      "Von der lichtdurchfluteten Sonnenterrasse bis zum außergewöhnlichen Turmzimmer — jede unserer sieben Wohnungen hat ihren eigenen Charakter. Blättern Sie durch und finden Sie Ihre Auszeit.",
    ...
    galleryTitle: "Ein Blick in unsere Wohnungen",
    galleryText: "Eindrücke aus der Ferienwohnung und der Moselregion. Klicken Sie auf ein Foto, um es vergrößert zu betrachten.",
    galleryPhotos: [
      { key: "wohnzimmer", alt: "Wohnzimmer" },
      { key: "balkon", alt: "Balkon & Moselblick" },
      { key: "kueche", alt: "Küche" },
      { key: "schlaf1", alt: "Schlafzimmer 1" },
      { key: "schlaf2", alt: "Schlafzimmer 2" },
      { key: "bad", alt: "Badezimmer" },
      { key: "aussen", alt: "Außenansicht" },
      { key: "weinberge", alt: "Weinberge bei Sonnenuntergang" },
      { key: "dorf", alt: "Dorfblick" },
    ],
    ...
    slider: {
      ariaLabel: "Unsere Wohnungen",
      unitLabel: "Wohnung {i} von {total}",
      photoLabel: "Foto {i} von {total}",
      prev: "Vorherige Wohnung",
      next: "Nächste Wohnung",
