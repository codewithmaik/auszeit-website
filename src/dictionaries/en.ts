...
export const dictionary: Dictionary = {
  ...
  wohnung: {
    ...
    heroTitle: "7 Apartments, One Home on the Moselle",
    heroText:
      "From the light-filled sun terrace to the extraordinary tower room — each of our seven apartments has its own character. Browse through and find your perfect getaway.",
    ...
    galleryTitle: "A Look Inside Our Apartments",
    galleryText: "Impressions from the holiday apartment and the Moselle region. Click a photo to view it enlarged.",
    galleryPhotos: [
      { key: "wohnzimmer", alt: "Living room" },
      { key: "balkon", alt: "Balcony & view of the Moselle" },
      { key: "kueche", alt: "Kitchen" },
      { key: "schlaf1", alt: "Bedroom 1" },
      { key: "schlaf2", alt: "Bedroom 2" },
      { key: "bad", alt: "Bathroom" },
      { key: "aussen", alt: "Exterior view" },
      { key: "weinberge", alt: "Vineyards at sunset" },
      { key: "dorf", alt: "Village view" },
    ],
    ...
    slider: {
      ariaLabel: "Our apartments",
      unitLabel: "Apartment {i} of {total}",
      photoLabel: "Photo {i} of {total}",
      prev: "Previous apartment",
      next: "Next apartment",
      goTo: "Jump to {name}",
      cta: "Enquire now",
    },
