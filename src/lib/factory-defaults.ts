// Kanonische "Werkseinstellungen" für die Kontakt-/Rechtstexte in siteSettings —
// exakt der Stand, den scripts/update-business-details.mts ursprünglich ins
// Prod-Deployment geschrieben hat. Dient dem Adminpanel-Werkseinstellungen-Reset
// (src/app/admin/(dashboard)/actions.ts) als Rücksetz-Ziel für die NOT-NULL-Felder,
// die (anders als die Design-Felder) keinen null=Fallback-Mechanismus haben.
//
// datenschutzDe/-En sind aus scripts/legal-content.mts übernommen (dessen
// Basistext von update-business-details.mts per .replace() personalisiert wird)
// statt von dort importiert, da Next.js Module außerhalb von src/ nicht auflöst.
