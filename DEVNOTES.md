...
**Noch offen (nächste Schritte dieser Session):** Phase 3 (Footer im Preview + editierbare Footer-Texte), Phase 4 (individuelle Button-Gestaltung + Link-Checkbox + Popup-Undo), Phase 5 (End-to-End-Test aller neuen Features + `ADMIN_PASSWORD_HASH` final zurücksetzen).
